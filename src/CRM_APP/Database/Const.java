...
public class Const {
    ...
    public static final String SURVEYTYPE_DES = "Des";
    //survey
...
//    survey detail
    ...
    public static final String QUESTIONTYPE_DES = "Des";
    //Question detail
    public static final String QUESTIONDETAIL_ID = "AID";
    public static final String QUESTIONDETAIL_ANSWER = "Answer";
